...
#     crewmate into the "Atlas" workspace
...
# --- 1. primary-shaped home: a crewmate spawns into the "Atlas" space ---
...
[ "$CM1_WS_LABEL" = "Atlas" ] || fail "a primary-shaped home's crewmate should land in the 'Atlas' workspace, got '$CM1_WS_LABEL'"
pass "real herdr E2E: the primary-shaped home's crewmate landed in the 'Atlas' workspace"
...
[ "$SM_WS_LABEL" = "Themis-e2esm1" ] || fail "a --secondmate spawn should land in 'Themis-<id>', got '$SM_WS_LABEL'"
