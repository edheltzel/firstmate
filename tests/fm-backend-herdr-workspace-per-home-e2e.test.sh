...
#     crewmate into the "Themis" workspace
...
# --- 1. primary-shaped home: a crewmate spawns into the "Themis" space ---
...
[ "$CM1_WS_LABEL" = "Themis" ] || fail "a primary-shaped home's crewmate should land in the 'Themis' workspace, got '$CM1_WS_LABEL'"
pass "real herdr E2E: the primary-shaped home's crewmate landed in the 'Themis' workspace"
