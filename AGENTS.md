...
config/worker-git-identity     optional signed worker Git identity policy containing public verification material but never a private signing key; LOCAL, gitignored, inherited into secondmate homes; see docs/configuration.md "Worker Git identity"
