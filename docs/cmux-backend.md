...
The cmux-specific home label uses `firstmate` for the primary home, or `2ndmate-<id>` when `$FM_HOME/.fm-secondmate-home` contains a secondmate id, and appends a short stable hash of the resolved `FM_ROOT` path.
