...
| `fm-teardown.sh`         | Fail-closed teardown: verify Treehouse task ownership before returning landed ship or completed scout worktrees, and retire secondmate homes |
